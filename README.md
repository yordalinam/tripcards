...
⏺️did not exctract all the possible components - for example, the PrimaryButton component could have been made more flexible - to be used for the other buttons
